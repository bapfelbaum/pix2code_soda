...
def pix2seq_shortcut(input_dir, super_output_dir, mode="train"):
    ...
    train_task_names = ["sign_ro_vehicle"]
...
if __name__ == "__main__":
    ...
    input_dir = "/media/bapfelbaum/ESD-USB/SWAP/Annotations/test_concepts/task_structuring/tasks/"
    super_output_dir = "/media/bapfelbaum/ESD-USB/SWAP/Annotations/test_concepts/task_structuring/taskoutputs/"
